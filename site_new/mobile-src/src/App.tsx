      ...
      <div className="min-h-screen bg-app text-gray-900 selection:bg-primary/20 selection:text-primary font-sans md:pl-64">
        ...
        <div className="w-full">
          <Routes>
            ...
            <Route path="/gulfstream" element={<Today selectedDate={selectedDate} onDateChange={handleDateChange} track="Gulfstream Park" fableOnly />} />
            <Route path="/monmouth" element={<Today selectedDate={selectedDate} onDateChange={handleDateChange} track="Monmouth Park" fableOnly />} />
            <Route path="/prairie-meadows" element={<Today selectedDate={selectedDate} onDateChange={handleDateChange} track="Prairie Meadows" fableOnly />} />
